...
typedef 	Boolean BinUsrPETTrackingFType2(PHG_BinParamsTy *binParams, PHG_BinDataTy *binData,
											...
											PHG_TrackingPhoton	*bluePhoton,
											PHG_TrackingPhoton	*pinkPhoton,
											LbUsEightByte *angleIndex,
											LbUsEightByte *distIndex,
											LbUsEightByte *tofIndex,
											LbUsEightByte *scatter1Index,
											LbUsEightByte *scatter2Index,
											LbUsEightByte *crystal1Index,
											LbUsEightByte *crystal2Index,
											LbUsEightByte *energy1Index,
											LbUsEightByte *energy2Index,
											LbUsEightByte *zDownIndex,
											LbUsEightByte *zUpIndex,
											LbUsEightByte *thetaIndex,
											LbUsEightByte *phiIndex,
											LbUsEightByte *xrIndex,
											LbUsEightByte *yrIndex,
